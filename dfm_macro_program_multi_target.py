...
class Macro(QWidget, Ui_Form):
    ...
    def start_macro(self):
        while True:
            ...
            pag.moveTo(
                rn.uniform(self.pos[1].x, self.pos[1].x + 140),
                rn.uniform(self.pos[1].y, self.pos[1].y + 35),
                rn.uniform(0.09, 0.13),
            )
            pag.click()

            pag.moveTo(
                rn.uniform(self.pos[2].x, self.pos[2].x + 160),
                rn.uniform(self.pos[2].y, self.pos[2].y + 35),
                rn.uniform(0.09, 0.13),
            )
            pag.click()
